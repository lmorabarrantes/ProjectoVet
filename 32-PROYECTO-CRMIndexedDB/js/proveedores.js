(function() {
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        if(window.indexedDB.open('crmP', 1)) {
            obtenerClientes();
        }
    ...
    function eliminarRegistro(e) {
        if (e.target.classList.contains("eliminar")) {
            ...
            if (confirmar) {
                const transaction = DB.transaction(["crmP"], "readwrite");
                const objectStore = transaction.objectStore("crmP");  
    ...
    function crearDB() {
        ...
        const crearDB = window.indexedDB.open('crmP', 1);
        ...
        crearDB.onupgradeneeded = function(e) {
            ...
            const objectStore = db.createObjectStore('crmP', { keyPath: 'id',  autoIncrement: true } );
    ...
    function obtenerClientes() {
        ...
        let abrirConexion = window.indexedDB.open('crmP', 1);
        ...
        abrirConexion.onsuccess = function() {
            ...
            const objectStore = DB.transaction('crmP').objectStore('crmP');
